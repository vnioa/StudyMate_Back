...
const ClientConstants = require('mysql2/lib/constants/client.js');
const ServerSatusFlags = require('mysql2/lib/constants/server_status.js');

const EncodingToCharset = require('mysql2/lib/constants/encoding_charset.js');
const sessionInfoTypes = require('mysql2/lib/constants/session_track.js');
