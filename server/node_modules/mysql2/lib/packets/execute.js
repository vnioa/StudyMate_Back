...
const CursorType = require('mysql2/lib/constants/cursor');
const CommandCodes = require('mysql2/lib/constants/commands');
const Types = require('mysql2/lib/constants/types');
